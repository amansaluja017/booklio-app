...
export const searchServices = asyncHandler(async (req: Request, res: Response) => {
  ...
  try {
    ...
    return res.status(200).json(new ApiResponse(200, { services: service }, "Services fetched successfully"));
  } catch (error) {
...
export const searchCategory = asyncHandler(async (req: Request, res: Response) => {
  ...
  try {
    ...
    return res.status(200).json(new ApiResponse(200, { searchedServices }, "Category and services fetched successfully"));
