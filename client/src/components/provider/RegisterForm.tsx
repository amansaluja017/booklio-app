...
export function RegisterForm() {
  ...
  const [setSetup, setSetUp] = useState<boolean>(false);
            ...
            <form onSubmit={handleSubmit(submit)}>
              <div className="flex flex-col gap-6">
                ...
                <div className="cursor-pointer flex justify-between">
                  <span onClick={() => navigate("/register")} className="text-sm text-blue-800 hover:underline">Register as customer?</span>
